...
const JUNK_TAG_RE = /\b(?:4\s*k|uhd|ultrahd|ultra\s*h\.?d|2160\s*p?|8\s*k|fhd|full\s*hd|1080\s*p?|720\s*p?|480\s*p?|360\s*p?|hd|sd|bluray|blu[-\s]?ray|web[-\s]?dl|webrip|hdtv|dvdrip|bdrip|brrip|dual(?:\s*áudio|\s*audio)?|multi(?:\s*áudio|\s*audio|\s*lang)?|dublado|legendado|legenda|nacional|original|extended|director'?s?\s*cut|unrated|remaster(?:ed)?|hevc|x265|x264|h\.?265|h\.?264|aac|ac3|dts|cam|hdcam|ts|hdts|tc|scr|screener|telesync|telecine)\b/gi;
