...
/** Detecta HLS mesmo quando a URL nao termina em .m3u8. */
            ...
            .apply {
                ...
                addListener(object : Player.Listener {
                    override fun onPlayerError(error: PlaybackException) {
                        ...
                        android.util.Log.e(
                            "PlayerScreen",
                            "Erro: ${error.errorCodeName} (${error.errorCode})",
                            error,
                        )
            ...
            Surface(
                ...
                Column(
                    ...
                    if (isRecovering && retryAttempt in 1..2) {
                        ...
                        Text(
                            "Tentando novamente ($retryAttempt/2)...",
                            color = Color.White,
