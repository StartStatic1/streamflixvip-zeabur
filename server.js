...
const adminFlixhub = require('./api/admin-flixhub.js');
const flixhubApi = require('./api/flixhub.js');
...
app.all('/api/admin-flixhub', wrap(adminFlixhub));
app.all('/api/flixhub/*', wrap(flixhubApi));
